from dashboard.tabs.statistics import Statistics
from dashboard.tabs.variants import Variants
from dashboard.tabs.variants_origins import VariantOrigins
